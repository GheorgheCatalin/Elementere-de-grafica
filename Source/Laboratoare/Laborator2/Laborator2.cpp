...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 0.5, 1)),
			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 0.5, 1)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 1)),
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.5, 0.5, 0.2)),
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 0.2, 0.2)),
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(1, 0.5, 1))
...

	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(1, 0,  0.5), glm::vec3(0, 0.5, 1)),
			VertexFormat(glm::vec3(0, 0.3,  1), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0.5, 1)),
		};
...

	{
		...
		meshes["circle"] = new Mesh("generated circle");
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(1.5, 0.5f, 0), glm::vec3(0.25f));

	RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 0.5f, 0), glm::vec3(0.75f));

	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 0.75, 2), glm::vec3(0.75f));
	
	RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(0, 1, -1), glm::vec3(1));
